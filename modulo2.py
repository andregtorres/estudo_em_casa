...
def arrowed_spines2(fig, ax, lims):
    #global fig, ax
...
if __name__=="__main__":
    ...
    for i in range(Nframes+1):
        ...
        legLabels=[composeLabelAbs(letters[0],1,0,0,exp),
                    composeLabelAbs(letters[1],1,1,3,exp),
                    composeLabelAbs(letters[2],2,1,3,exp),]
        if labels:
